    ...
    render() {
        return (
            <div>
                ...
                <div className="frame-container" style = {{backgroundImage:`url(${this.state.frameSrc})`, height:"100vh", backgroundSize:"100% 100%"}}>
                ...
                <div className="message-container" style={{ bottom: window.innerHeight * 0.26 }}>
                ...
                {(this.state.isErrorStatus) && <div className = "errorMessage" style={{ bottom: window.innerHeight * 0.13 }}>
