    ...
    render() {
        return (
            <div>
                ...
                <div className="message-container" style={{ bottom: window.innerHeight * 0.29 }}>
                ...
                {(this.state.isErrorStatus) && <div className = "errorMessage" style={{ bottom: window.innerHeight * 0.16 }}>
